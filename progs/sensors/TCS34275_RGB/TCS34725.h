 ...
 *       Adapted from Arduino TCS34725 Library : 
...
#define DEBUG_TCS       true

#define TCS34725_FREQ           400000

#define TCS34725_ADD            0x29    /**< I2C address **/
#define TCS34725_CMD_BIT        0x80    /**< Command bit **/
...
/**
 * @class TCS34725
 * @brief Class for access RGB data of a TCS34725 sensor
 * @details     Communication is through an I2C protocol at 400kHz.
 */
class TCS34725 {
    public:        
        /**
        * @brief Simple constructor of the TCS34275 class.
        * @details Create a TCS34275 object with an I2C interface
        ...
        * @return   true if TCS34275 is recognized (ID = 0x44)
        */
        bool init(void);

        /**
        * @brief Set the integration time.
        * @param it Integration time value, from TCS34275.h
        * @return   true if TCS34275 acknolewdged
        */
        bool setIntegrationTime(uint8_t it);

        /**
        * @brief Set the gain.
        * @param gain Gain value, from TCS34275.h
        * @return   true if TCS34275 acknolewdged
        */
        bool setGain(tcs34725Gain_t gain);

        /**
        * @brief Enable RGB data acquisition.
        * @return   true if TCS34275 acknolewdged
        */       
        bool enable();

        /**
        * @brief Disable RGB sensor.
        * @return   true if TCS34275 acknolewdged
        */ 
        bool disable();
